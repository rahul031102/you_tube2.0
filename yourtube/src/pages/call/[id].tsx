...
//   }, [id]);
// // ADD after setRoomId line:
// const toName = params.get("toName") ? decodeURIComponent(params.get("toName")!) : id;
...
//           <div className="text-sm text-gray-600">calling: {id}</div>
      ...
      <div className="max-w-5xl mx-auto space-y-4">
        ...
        {!connected && role === "caller" && (
          <div className="bg-gray-900 rounded-lg p-8 text-center text-white">
            <div className="text-2xl font-semibold mb-2">Calling {calleeName}...</div>
